...
!function (t) {
        ...
        var r = function () {
            ...
            return t.prototype.encode = function (t, e, n) {
                ...
                for (var o = 0; o < t.length; o++)
                    "L" == e[o] ? r += this.Lbinary[t[o]] : "G" == e[o] ? r += this.Gbinary[t[o]] : "R" == e[o] && (r += this.Rbinary[t[o]]),
                        o < t.length - 1 && (r += n);
                return r
            }
                ,
        ...
        var u = n(0)
            ...
            , f = function (t) {
                function e() {
                    ...
                    return n.name = "InvalidStartCharacterException",
    ...
    , function (t, e) {
        ...
        var i = function (t) {
            function e(o, i) {
                ...
                return a.name = "InvalidInputException",
                    a.symbology = o,
                    a.input = i,
            ...
            , a = function (t) {
                function e() {
                    ...
                    return o.name = "InvalidElementException",
            ...
            , u = function (t) {
                function e() {
                    n(this, e);
                    var o = r(this, t.call(this));
                    return o.name = "NoElementException",
    ...
    , function (t, e, n) {
        ...
        function o(t) {
            ...
            if (t && "object" === ("undefined" == typeof t ? "undefined" : u(t)) && !t.nodeName)
                return {
                    element: t,
    ...
    , function (t, e, n) {
        ...
        var u = n(4)
            ...
            , c = function (t) {
                function e(n, r) {
                    return o(this, e),
                        i(this, t.call(this, String.fromCharCode(208) + n, r))
                }
                return a(e, t),
                    e.prototype.valid = function () {
    ...
    , function (t, e, n) {
        ...
        var u = n(4)
            ...
            , c = function (t) {
                function e(n, r) {
                    return o(this, e),
                        i(this, t.call(this, String.fromCharCode(209) + n, r))
                }
                return a(e, t),
                    e.prototype.valid = function () {
    ...
    , function (t, e, n) {
        ...
        var u = n(4)
            ...
            , c = function (t) {
                function e(n, r) {
                    return o(this, e),
                        i(this, t.call(this, String.fromCharCode(210) + n, r))
                }
                return a(e, t),
                    e.prototype.valid = function () {
    ...
    , function (t, e, n) {
        ...
        function u(t) {
            ...
            return e = o >= 2 ? String.fromCharCode(210) + f(t) : n > r ? String.fromCharCode(208) + s(t) : String.fromCharCode(209) + c(t),
    ...
    , function (t, e, n) {
        ...
        var s = n(1)
            ...
            , p = function (t) {
                function e(n, r) {
                    o(this, e),
                        n.search(/^[0-9]{12}$/) !== -1 && (n += u(n));
                    var a = i(this, t.call(this, n, r));
                    return !r.flat && r.fontSize > 10 * r.width ? a.fontSize = 10 * r.width : a.fontSize = r.fontSize,
        ...
        var u = n(1)
            ...
            , l = function (t) {
                function e(n, r) {
                    o(this, e);
                    var a = i(this, t.call(this, n, r));
                    return a.structure = ["LL", "LG", "GL", "GG"],
                        a
                }
                return a(e, t),
                    e.prototype.valid = function () {
        ...
        var u = n(1)
            ...
            , l = function (t) {
                function e(n, r) {
                    o(this, e);
                    var a = i(this, t.call(this, n, r));
                    return a.structure = ["GGLLL", "GLGLL", "GLLGL", "GLLLG", "LGGLL", "LLGGL", "LLLGG", "LGLGL", "LGLLG", "LLGLG"],
                        a
                }
                return a(e, t),
                    e.prototype.valid = function () {
                    ...
                    e.prototype.checksum = function () {
                        var t = 0;
                        return t += 3 * parseInt(this.data[0]),
    ...
    , function (t, e, n) {
        ...
        var s = n(1)
            ...
            , p = function (t) {
                function e(n, r) {
                    o(this, e),
                        n.search(/^[0-9]{11}$/) !== -1 && (n += u(n));
                    var a = i(this, t.call(this, n, r));
                    return a.displayValue = r.displayValue,
                        r.fontSize > 10 * r.width ? a.fontSize = 10 * r.width : a.fontSize = r.fontSize,
                        a.guardHeight = r.height + a.fontSize / 2 + r.textMargin,
                        a
                }
                return a(e, t),
        ...
        var u = n(0)
            ...
            , c = function (t) {
                function e(n, r) {
                    ...
                    return a.text = a.options.text || a.text.replace(/[A-D]/g, ""),
                        a
                }
                return a(e, t),
                    e.prototype.valid = function () {
    ...
    , function (t, e, n) {
        ...
        function o(t) {
            ...
            for (var n in s["default"])
                s["default"].hasOwnProperty(n) && (t.hasAttribute("jsbarcode-" + n.toLowerCase()) && (e[n] = t.getAttribute("jsbarcode-" + n.toLowerCase())),
                    ...
                    t.prototype.drawCanvasText = function (t, e) {
                        ...
                        if (t.displayValue) {
                            ...
                            i = "top" == t.textPosition ? t.marginTop + t.fontSize - t.textMargin : t.height + t.textMargin + t.marginTop + t.fontSize,
                                n.font = r,
                                "left" == t.textAlign || e.barcodePadding > 0 ? (o = 0,
                                    n.textAlign = "left") : "right" == t.textAlign ? (o = e.width - 1,
                                        n.textAlign = "right") : (o = e.width / 2,
                                            n.textAlign = "center"),
                ...
                return t.prototype.render = function () {
                    ...
                    t.prototype.prepareSVG = function () {
                        ...
                        this.setSvgAttributes(n, e),
                            this.options.background && u(0, 0, n, e, this.svg).setAttribute("style", "fill:" + this.options.background + ";")
                    }
                    ,
                    t.prototype.drawSvgBarcode = function (t, e, n) {
                        ...
                        for (var i = 0, a = 0, s = 0; s < o.length; s++)
                            a = s * e.width + n.barcodePadding,
                                "1" === o[s] ? i++ : i > 0 && (u(a - e.width * i, r, e.width * i, e.height, t),
                                    i = 0);
                    ...
                    t.prototype.drawSVGText = function (t, e, n) {
                        ...
                        if (e.displayValue) {
                            ...
                            r.setAttribute("style", "font:" + e.fontOptions + " " + e.fontSize + "px " + e.font),
                                ...
                                "left" == e.textAlign || n.barcodePadding > 0 ? (o = 0,
                                    r.setAttribute("text-anchor", "start")) : "right" == e.textAlign ? (o = n.width - 1,
                                        r.setAttribute("text-anchor", "end")) : (o = n.width / 2,
    ...
    , function (t, e, n) {
        ...
        function o(t, e) {
            E.prototype[e] = E.prototype[e.toUpperCase()] = E.prototype[e.toLowerCase()] = function (n, r) {
                ...
                return o._errorHandler.wrapBarcodeCall(function () {
                    ...
                    var a = (0,
                        l["default"])(o._options, r);
                    a = (0,
                        _["default"])(a);
                    var u = t[e]
                        , s = i(n, u, a);
                    return o._encodings.push(s),
                        o
                })
            }
        }
        function i(t, e, n) {
            ...
            var r = new e(t, n);
            if (!r.valid())
                throw new m.InvalidInputException(r.constructor.name, t);
            var o = r.encode();
            o = (0,
                h["default"])(o);
            for (var i = 0; i < o.length; i++)
                o[i].options = (0,
                    l["default"])(n, o[i].options);
            return o
        }
        function a() {
        ...
        E.prototype.options = function (t) {
            ...
            E.prototype.init = function () {
                if (this._renderProperties) {
                    ...
                    for (var e in this._renderProperties) {
                        ...
                        var n = (0,
                            l["default"])(this._options, t.options);
            ...
            E.prototype.render = function () {
                if (!this._renderProperties)
                    throw new m.NoElementException;
